...
pub type R = crate::R<WDOGCOUNT_SPEC>;
#[doc = "Register `wdogcount` writer"]
pub type W = crate::W<WDOGCOUNT_SPEC>;
impl core::fmt::Debug for R {
    fn fmt(&self, f: &mut core::fmt::Formatter) -> core::fmt::Result {
        write!(f, "{}", self.bits())
    }
}
impl core::fmt::Debug for crate::generic::Reg<WDOGCOUNT_SPEC> {
...
#[doc = "Counter Register\n\nYou can [`read`](crate::generic::Reg::read) this register and get [`wdogcount::R`](R).  You can [`reset`](crate::generic::Reg::reset), [`write`](crate::generic::Reg::write), [`write_with_zero`](crate::generic::Reg::write_with_zero) this register using [`wdogcount::W`](W). You can also [`modify`](crate::generic::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
